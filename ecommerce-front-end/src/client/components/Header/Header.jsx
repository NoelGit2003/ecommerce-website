  ...
  return (
    <>
      <div className="box">
            ...
            <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
             ...
             <a href="/" className="d-flex align-items-center my-2 my-lg-0 me-lg-auto text-white text-decoration-none">
              ...
              <ul className="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
                ...
                <li>
                  <a href="#" className="nav-link text-white h-navItems">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" class="bi bi-list-check" viewBox="0 0 16 16">
        ...
        <div className=" text-bg-dark px-3 py-3 border-bottom mb-3">
          <div className="container d-flex flex-wrap justify-content-center">
            ...
            <div className="text-end me-12 h-sign-in-up">
              {/* <button type="button" className="btn btn-light text-dark me-4">Login</button> */}
